...
while True:
    try:
        ...
        # if config['Resident_in_California']:
        #     driver.find_element_by_xpath("//*[contains(@aria-label, 'resident in California')]/../div[2]/label").click()
        # else:
        #     driver.find_element_by_xpath("//*[contains(@aria-label, 'resident in California')]/../div[1]/label").click()
        ...
        fill_filled_textbox(driver.find_element_by_id("field-phone"), config['myphone'])

        # driver.find_element_by_xpath(f"//*[text()='{get_option(config['SELECT_ONLY_ONE_which_dose'])}']/../..").click()
        # driver.find_element_by_id(get_option(config['SELECT_ONLY_ONE_which_dose']).click()
        if config['RECEIVED_a_dose']:
            driver.find_element_by_id("dose2").click()
        else:
            driver.find_element_by_id("dose1").click()
        ...
        driver.find_element_by_id("wag-store-info-0").click()
